...
function Footer()
{
    ...
    // Número de página
    $this->Cell(0,10,utf8_decode('Esta página está basada en la colaboración voluntaria,
por lo que no se hace responsable de la veracidad de los contenidos publicados.'),0,0,'C');
}
}
...
$pdf->Cell(40, 8, 'Equipo', 0);
$pdf->Cell(24, 8, 'P. Ganados', 0);
$pdf->Cell(24, 8, 'P. Empatados', 0);
